...
export const BODY_REGIONS: BodyRegion[] = [
  ...
  // Scalp — top half of head (above brow line y ≈ 36)
  {
    key: "scalp",
    view: "front",
    labelKey: "bodymap_region_scalp",
    path: "M 100 8 C 120 8 126 20 126 36 L 74 36 C 74 20 80 8 100 8 Z",
    centroid: { x: 100, y: 23 },
  },

  // Forehead — brow line to mid-face
  {
    key: "forehead",
    view: "front",
    labelKey: "bodymap_region_forehead",
    path: "M 74 36 C 74 46 78 54 84 58 L 116 58 C 122 54 126 46 126 36 Z",
    centroid: { x: 100, y: 47 },
  },
  ...
  // Left cheek (patient's left = viewer's right, larger x)
  {
    ...
    path: "M 109 58 L 123 62 C 127 70 125 80 121 84 L 109 84 Z",
    centroid: { x: 117, y: 72 },
  },
  ...
  // Right cheek (patient's right = viewer's left, smaller x)
  {
    ...
    path: "M 91 58 L 77 62 C 73 70 75 80 79 84 L 91 84 Z",
    centroid: { x: 83, y: 72 },
  },
  ...
  // Nose (centre strip)
  {
    ...
    path: "M 95 58 L 105 58 C 106 68 106 76 105 84 L 95 84 C 94 76 94 68 95 58 Z",
    centroid: { x: 100, y: 71 },
  },
  ...
  // Chin / jaw
  {
    ...
    path: "M 80 84 C 82 90 90 97 100 98 C 110 97 118 90 120 84 Z",
    centroid: { x: 100, y: 92 },
  },
  ...
  // Neck
  {
    ...
    path: "M 90 98 C 90 105 89 112 89 118 L 111 118 C 111 112 110 105 110 98 Z",
