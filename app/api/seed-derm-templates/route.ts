...
const DERM_TEMPLATES = [
  ...
  // ── Additional templates (14 more to reach 34 total) ──────────────
  {
    name: "Nummular/Discoid Eczema",
    condition: "eczema",
    condition_display: "Eczema (Atopic Dermatitis)",
    category: "dermatology",
    medicines: [
      { name: "Cr. Betamethasone Valerate 0.1% (Betnovate C)", dosage: "Apply on patches", frequency: "Twice daily", duration: "2-3 weeks", instructions: "On coin-shaped patches only" },
      { name: "Ceramide Moisturizer (Cetaphil DAM)", dosage: "Apply generously", frequency: "3-4 times daily", duration: "Continuous", instructions: "Whole body, especially after bath" },
      { name: "Tab. Levocetirizine 5mg (Xyzal)", dosage: "0-0-1", frequency: "Once daily", duration: "2-3 weeks", instructions: "For itching" },
    ],
    special_instructions: "Coin-shaped patches are characteristic. Avoid hot water bathing. Moisturize heavily. Condition tends to recur in winter — start preventive moisturizing before winter. Avoid scratching.",
    follow_up_days: 21,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Chronic Contact Dermatitis / Irritant Dermatitis",
    condition: "contact_dermatitis",
    condition_display: "Contact Dermatitis",
    category: "dermatology",
    medicines: [
      { name: "Cr. Clobetasol 0.05% (Tenovate)", dosage: "Apply on patches", frequency: "Once daily", duration: "7-10 days max", instructions: "Potent steroid — short course only. NOT for children" },
      { name: "Ceramide Barrier Cream (Physiogel AI)", dosage: "Apply generously", frequency: "3-4 times daily", duration: "Continuous", instructions: "Rebuild skin barrier" },
      { name: "Tab. Levocetirizine 5mg (Xyzal)", dosage: "0-0-1", frequency: "Once daily", duration: "2-3 weeks", instructions: "For itching" },
    ],
    special_instructions: "Avoid all harsh soaps, detergents and chemicals on affected area. Use gloves when handling irritants. Apply barrier cream before exposure to irritants. Chronic dermatitis takes weeks to resolve — be patient.",
    follow_up_days: 14,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Urticaria with Angioedema",
    condition: "urticaria",
    condition_display: "Urticaria (Hives)",
    category: "dermatology",
    medicines: [
      { name: "Inj. Adrenaline 0.5mg IM 1:1000", dosage: "0.5ml IM stat", frequency: "EMERGENCY stat dose", duration: "Single dose", instructions: "ONLY if airway compromise — anterolateral thigh" },
      { name: "Tab. Prednisolone 40mg (Omnacortil 20 x2)", dosage: "40mg stat then taper", frequency: "Once daily", duration: "5-7 days taper", instructions: "After food. 40mg x2d, 30mg x2d, 20mg x1d, 10mg x1d" },
      { name: "Tab. Levocetirizine 5mg (Xyzal)", dosage: "1-0-1", frequency: "Twice daily", duration: "2-3 weeks", instructions: "Continue after steroid course" },
      { name: "Tab. Pantoprazole 40mg (Pan 40)", dosage: "1-0-0", frequency: "Once daily", duration: "While on steroids", instructions: "Before food. Gastric protection" },
    ],
    special_instructions: "EMERGENCY: If lips/tongue/throat swelling or difficulty breathing — go to ER immediately. After stabilization, identify trigger and STRICTLY avoid. Consider carrying emergency adrenaline auto-injector. Medic alert bracelet recommended.",
    follow_up_days: 3,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Seborrheic Keratosis — Observation",
    condition: "benign_lesion",
    condition_display: "Benign Skin Lesion",
    category: "dermatology",
    medicines: [
      { name: "Sunscreen SPF 50+ (La Shield Fisico)", dosage: "Apply generously", frequency: "Daily", duration: "Continuous", instructions: "Sun protection" },
    ],
    special_instructions: "Seborrheic keratosis is a completely BENIGN (non-cancerous) growth. No treatment needed unless cosmetically bothersome. If removal desired, options include cryotherapy or electrocautery (minor OPD procedure). Consult if lesion suddenly changes, bleeds, or becomes painful.",
    follow_up_days: null,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Skin Tags (Acrochordons)",
    condition: "benign_lesion",
    condition_display: "Benign Skin Lesion",
    category: "dermatology",
    medicines: [],
    special_instructions: "Skin tags are completely BENIGN and harmless. No medication required. If removal desired for cosmetic reasons, electrocautery or snip excision can be done as a minor OPD procedure. Common in skin folds (neck, axillae, groin). Associated with obesity and insulin resistance — consider blood sugar check if multiple skin tags present.",
    follow_up_days: null,
    is_system: true,
    usage_count: 0,
  },
  {
    ...
    category: "dermatology",
    medicines: [
      { name: "Cr. Arbutin + Kojic Acid (Kojivit Cream)", dosage: "Apply at night on dark spots", frequency: "Once daily", duration: "8-12 weeks", instructions: "Gentle depigmenting agent" },
      { name: "Gel Adapalene 0.1% (Deriva Gel)", dosage: "Apply alternate nights", frequency: "Alternate nights", duration: "8-12 weeks", instructions: "Promotes cell turnover" },
      { name: "Sunscreen SPF 50+ (UV Doux SPF 50)", dosage: "Apply generously", frequency: "Every 3 hours", duration: "Continuous", instructions: "Essential — sun makes PIH darker" },
    ],
    special_instructions: "PIH fades naturally over 6-12 months but treatment speeds this up. Sunscreen is critical. Do not pick scabs or squeeze pimples. Be patient, results take 8-12 weeks. Chemical peels may be considered if topical treatment insufficient.",
    follow_up_days: 42,
    is_system: true,
    usage_count: 0,
  },
  {
    ...
    category: "dermatology",
    medicines: [
      { name: "Tab. Amoxicillin-Clavulanate 625mg (Augmentin 625)", dosage: "1-0-1", frequency: "Twice daily", duration: "7-10 days", instructions: "Before food. Complete full course even if improved" },
      { name: "Tab. Ibuprofen 400mg (Brufen 400)", dosage: "1-0-1 as needed", frequency: "As needed for pain", duration: "3-5 days", instructions: "After food. For pain and inflammation" },
      { name: "Tab. Pantoprazole 40mg (Pan 40)", dosage: "1-0-0", frequency: "Once daily", duration: "While on painkillers", instructions: "Before food. Gastric protection" },
    ],
    special_instructions: "Cellulitis is a SERIOUS bacterial skin infection. Mark the border of redness with a pen — if it spreads beyond the mark, return immediately or go to ER. Elevate the affected limb. Rest. If fever >101°F, increasing pain, or red streaks spreading — seek emergency care. Control blood sugar if diabetic.",
    follow_up_days: 3,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Folliculitis / Furuncle (Boil)",
    condition: "bacterial_infection",
    condition_display: "Bacterial Infection",
    category: "dermatology",
    medicines: [
      { name: "Tab. Cephalexin 500mg (Sporidex 500)", dosage: "1-0-1", frequency: "Twice daily", duration: "5-7 days", instructions: "Before food. Only if multiple or recurrent" },
      { name: "Oint. Mupirocin 2% (T-Bact)", dosage: "Apply on bumps/boils", frequency: "Thrice daily", duration: "7-10 days", instructions: "" },
      { name: "Benzoyl Peroxide 5% Wash (Persol AC 5%)", dosage: "Apply on affected area while bathing", frequency: "Once daily", duration: "2-3 weeks", instructions: "Leave on 2-3 min, then rinse" },
    ],
    special_instructions: "Do NOT squeeze or pop boils — this spreads infection. Apply warm compress for 15 min, 3-4 times daily to promote drainage. Keep area clean and dry. Avoid shaving over affected area. If recurrent, check blood sugar (diabetes screening). Use clean towels daily.",
    follow_up_days: 7,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Herpes Simplex (Cold Sore / Genital Herpes)",
    condition: "viral_infection",
    condition_display: "Viral Infection",
    category: "dermatology",
    medicines: [
      { name: "Tab. Acyclovir 400mg (Zovirax 400)", dosage: "1-1-1", frequency: "Thrice daily", duration: "5-7 days", instructions: "After food. Start within 72 hours of symptoms" },
      { name: "Cr. Acyclovir 5% (Zovirax Cream)", dosage: "Apply on lesions", frequency: "5 times daily", duration: "5-7 days", instructions: "Every 4 hours while awake" },
      { name: "Tab. Paracetamol 500mg (Dolo 500)", dosage: "1-0-1 as needed", frequency: "As needed", duration: "As needed", instructions: "For pain/fever" },
    ],
    special_instructions: "Herpes is caused by a virus that stays in the body permanently and can recur. Avoid kissing or intimate contact during active lesions. Do not touch lesions then touch eyes. Triggers: stress, fever, sun exposure, menstruation. Start medication at FIRST tingle/burning for best results. NOT curable but manageable.",
    follow_up_days: 7,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Viral Warts / Molluscum Contagiosum",
    condition: "viral_infection",
    condition_display: "Viral Infection",
    category: "dermatology",
    medicines: [
      { name: "Sol. Salicylic Acid 16.7% + Lactic Acid 16.7% (Duofilm)", dosage: "Apply daily on wart only", frequency: "Once daily", duration: "4-12 weeks", instructions: "Protect surrounding skin with vaseline" },
      { name: "Cr. Imiquimod 5% (Imiquad)", dosage: "Apply alternate nights on wart", frequency: "Alternate nights", duration: "8-12 weeks", instructions: "Wash off after 6-8 hours" },
    ],
    special_instructions: "Warts are caused by HPV virus and are contagious. Do not pick, scratch or bite warts. File down dead skin weekly with pumice stone (do not share). Warts may take 8-12 weeks to resolve. If topical treatment fails, cryotherapy is an option. In children, many warts resolve spontaneously within 1-2 years.",
    follow_up_days: 28,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Pemphigus Vulgaris (Initial Management)",
    condition: "bullous_disease",
    condition_display: "Bullous Disease (Blistering Disorder)",
    category: "dermatology",
    medicines: [
      { name: "Tab. Prednisolone 1mg/kg/day (Omnacortil)", dosage: "40-60mg/day based on weight", frequency: "Once daily morning", duration: "Weeks-months with slow taper", instructions: "After food. HIGH dose — specialist supervision mandatory" },
      { name: "Tab. Azathioprine 50mg (Imuran 50)", dosage: "1-0-1 (2-3mg/kg/day)", frequency: "Twice daily", duration: "Months-years", instructions: "After food. Steroid-sparing agent — check TPMT before starting" },
      { name: "Tab. Pantoprazole 40mg (Pan 40)", dosage: "1-0-0", frequency: "Once daily", duration: "While on steroids", instructions: "Before food. Gastric protection" },
      { name: "Tab. Calcium 500mg + Vitamin D3 (Shelcal 500)", dosage: "0-0-1", frequency: "Once daily", duration: "While on steroids", instructions: "After food. Bone protection during long steroid use" },
    ],
    special_instructions: "Pemphigus is a SERIOUS autoimmune blistering disease requiring long-term specialist management. Baseline tests: CBC, LFT, KFT, blood sugar, TPMT. Monthly blood monitoring mandatory. Eat soft diet if oral blisters present. HIGH infection risk on immunosuppressants — avoid crowds, report any fever immediately. DO NOT stop steroids suddenly.",
    follow_up_days: 7,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Bullous Pemphigoid (Initial Management)",
    condition: "bullous_disease",
    condition_display: "Bullous Disease (Blistering Disorder)",
    category: "dermatology",
    medicines: [
      { name: "Tab. Prednisolone 0.5mg/kg/day (Omnacortil)", dosage: "30-40mg/day", frequency: "Once daily morning", duration: "Weeks, then taper", instructions: "After food. Lower dose than pemphigus" },
      { name: "Tab. Doxycycline 100mg (Doxt-SL)", dosage: "1-0-1", frequency: "Twice daily", duration: "4-8 weeks", instructions: "After food. Anti-inflammatory effect in BP" },
      { name: "Cr. Clobetasol Propionate 0.05% (Tenovate)", dosage: "Apply on blisters", frequency: "Twice daily", duration: "2-4 weeks", instructions: "Super-potent topical steroid for localized disease" },
      { name: "Tab. Pantoprazole 40mg (Pan 40)", dosage: "1-0-0", frequency: "Once daily", duration: "While on steroids", instructions: "Before food. Gastric protection" },
    ],
    special_instructions: "Bullous pemphigoid usually affects elderly patients (>60 yrs). Better prognosis than pemphigus. Blisters are tense and less likely to rupture. Keep blisters intact — do not burst. Gentle wound care with saline and mupirocin. Blood monitoring: CBC, blood sugar monthly. Watch for steroid side effects.",
    follow_up_days: 7,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Scabies with Secondary Bacterial Infection",
    condition: "scabies",
    condition_display: "Scabies",
    category: "dermatology",
    medicines: [
      { name: "Tab. Cephalexin 500mg (Sporidex 500)", dosage: "1-0-1", frequency: "Twice daily", duration: "7 days", instructions: "Before food. Treat infection FIRST before scabicide" },
      { name: "Oint. Mupirocin 2% (T-Bact)", dosage: "Apply on infected areas", frequency: "Thrice daily", duration: "7 days", instructions: "On pus-filled or crusted lesions" },
      { name: "Permethrin 5% Lotion (Permite)", dosage: "Apply whole body neck down", frequency: "Day 1 and Day 8 of scabicide", duration: "2 applications", instructions: "START ONLY after secondary infection controlled (Day 3-5)" },
      { name: "Tab. Ivermectin 12mg (Ivecop 12)", dosage: "200mcg/kg", frequency: "Day 1 and Day 8 of scabicide", duration: "2 doses", instructions: "Before food. Start with permethrin, not before" },
      { name: "Tab. Cetirizine 10mg (Okacet)", dosage: "1-0-1", frequency: "Twice daily", duration: "2-3 weeks", instructions: "For intense itching" },
    ],
    special_instructions: "IMPORTANT: Treat the bacterial infection FIRST for 3-5 days, THEN apply scabicide. Applying permethrin on broken/infected skin increases irritation. All family members still need simultaneous treatment. Wash all linens in hot water. If pus or fever present, infection is priority.",
    follow_up_days: 3,
    is_system: true,
    usage_count: 0,
  },
  {
    name: "Crusted (Norwegian) Scabies",
    condition: "scabies",
    condition_display: "Scabies",
    category: "dermatology",
    medicines: [
      { name: "Tab. Ivermectin 12mg (Ivecop 12)", dosage: "200mcg/kg on Day 1, 2, 8, 9, 15", frequency: "Multiple doses over 2 weeks", duration: "2 weeks", instructions: "Before food. More aggressive dosing than regular scabies" },
      { name: "Permethrin 5% Lotion (Permite)", dosage: "Apply daily for 7 days, then twice weekly", frequency: "Daily then 2x/week", duration: "2-4 weeks", instructions: "Much more frequent than regular scabies" },
      { name: "Cr. Salicylic Acid 5% in Vaseline", dosage: "Apply before permethrin", frequency: "Before each permethrin application", duration: "1-2 weeks", instructions: "Keratolytic — removes thick crusts to allow permethrin penetration" },
      { name: "Tab. Cetirizine 10mg (Okacet)", dosage: "1-0-1", frequency: "Twice daily", duration: "3-4 weeks", instructions: "" },
    ],
    special_instructions: "Crusted scabies is EXTREMELY contagious — patient has millions of mites vs hundreds in regular scabies. ISOLATION recommended. Healthcare workers must use gloves. All contacts need treatment. May need hospitalization in severe cases. Check for underlying immunosuppression (HIV, steroids, organ transplant). Remove crusts with keratolytic before applying permethrin.",
    follow_up_days: 3,
    is_system: true,
    usage_count: 0,
  },
